  ...
  <div class="row">
      ...
      <div class="col-sm-9 col-md-9"> <!-- col-md-9 -->
                    ...
                    <p style="float:right; margin-top:-20px; ">  Returns and Replacements Are Only Accepted If Product Is Not Tampered.</p>
                           ...
                           <div class="panel panel-default  panel--styled">
                              <div class="panel-body">
                                <div class="col-md-12 panelTop">  
                                 ...
                                 <p>Replacement Request Date:{{date('d-m-y', strtotime($order->created_at))}}</p>
                          ...
                          Status: @if($order->order->order_status=="replacement") Request Processing..
                                  @else  Replacement Done!
                                  @endif
                        </div>
